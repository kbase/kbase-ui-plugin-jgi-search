define(['kb_lib/jsonRpc/genericClient', 'kb_lib/props'], function (GenericClient, props) {
    'use strict';
    ...
    class Profile {
        ...
        updateUserProfile(profileUpdate) {
            return this.profileService
                .callFunc('update_user_profile', [profileUpdate])
                .then(() => {
                    return [true, null];
                })
                .catch((err) => {
        ...
        saveJgiAgreement(agreed) {
            ...
            return this.profileService
                .callFunc('get_user_profile', [[username]])
                .spread((profiles) => {
        ...
        getHistory(name) {
            ...
            return this.profileService
                ...
                .spread((profiles) => {
                    ...
                    let keys;
                    if (name === 'search') {
                        keys = [key, ['profile', 'plugins', 'jgi-search', 'settings', 'searchInputHistory']];
                    } else {
                        keys = [key];
                    }
