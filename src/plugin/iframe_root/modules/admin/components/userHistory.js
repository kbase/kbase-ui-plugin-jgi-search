define([
    ...
    'kb_lib/props'
], function (ko, reg, SubscriptionManager, html, htmlBuilders, GenericClient, props) {
    'use strict';
    ...
    function getAllProfilesWithAgreement(runtime) {
        ...
        return userProfileService
            ...
            .spread(function (result) {
                var profilesWithAgreement = result.reduce(function (profiles, rawProfile) {
                    var profile = new props.Props({ data: rawProfile });
    ...
    function viewModel(params, componentInfo) {
        ...
        function fetchData() {
            ...
            status('fetching');
            getAllProfilesWithAgreement(runtime).then(function (foundProfiles) {
    ...
    function buildLayout() {
        return div([
            ...
            div(
                ...
                htmlBuilders.loading('Loading user profiles')
            ),
            '<!-- /ko -->',
